...
export default function MTT300HG20DetailPage() {
  const urunDetay = {
    model: "MT T300 HG20",
    title: "Hızlı Geçiş Turnike Sistemi",
    image: HIZLI_GECIS_TURNIKE_IMAGES.hg1,
    price: "Fiyat İçin Ara",
    description: "Yüksek kapasiteli hızlı geçiş kontrolü sağlayan profesyonel turnike sistemi. Metro istasyonları, havaalanları ve büyük alışveriş merkezleri için ideal çözüm.",
    
    teknikOzellikler: {
      "Geçiş Kapasitesi": "20 Kişi/Dakika",
      "Motor Tipi": "Servo Motor",
      "Açılma Süresi": "0.5 Saniye",
      "Kasa Malzemesi": "304 Paslanmaz Çelik",
      "Boyutlar": "1200 x 280 x 1000 mm",
      "Ağırlık": "85 kg",
      ...
      "Ses Uyarısı": "Dahili Hoparlör",
      "LED Gösterge": "Çift Taraflı LED"
    },

    ozellikler: [
      "20 kişi/dakika yüksek kapasite",
      "RFID kart okuyucu entegrasyonu",
      "Çift taraflı LED durum göstergesi",
    ...
    aksesuar: [
      ...
      "QR kod okuyucu",
      "Fotosel güvenlik sensörleri",
      "Uzaktan kumanda sistemi",
      "Yedek güç kaynağı (UPS)",
      "Güvenlik kameraları",
  ...
  return (
    <>
      <Helmet>
        <title>MT T300 HG20 Hızlı Geçiş Turnike - 20 Kişi/Dakika | Mika Teknoloji</title>
        <meta name="description" content="MT T300 HG20 hızlı geçiş turnike sistemi. 20 kişi/dakika kapasiteli, RFID destekli, metro ve havaalanları için profesyonel çözüm." />
        <meta name="keywords" content="t300 hg20, hızlı geçiş turnike, 20 kişi dakika, rfid turnike, metro turnike, havaalanı turnike, mika teknoloji" />
      </Helmet>
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <Badge className="bg-green-600 text-white mb-2">{urunDetay.model}</Badge>
      ...
      <div className="bg-gray-50 py-4">
        <div className="container mx-auto px-4">
          <div className="flex items-center text-sm text-gray-600">
            ...
            <span className="mx-2">/</span>
            <span className="text-primary font-medium">MT T300 HG20</span>
          </div>
        </div>
      </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              MT T300 HG20 hızlı geçiş turnike sistemi geniş kullanım alanına sahiptir
            </p>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto">
            <h2 className="text-3xl font-bold mb-6">
              MT T300 HG20 Hızlı Geçiş Turnikenizi Hemen Sipariş Edin
            </h2>
            <p className="text-xl mb-8 text-white/90">
              20 kişi/dakika kapasiteli profesyonel çözüm için hemen iletişime geçin. Ücretsiz keşif ve detaylı teklif.
            </p>
