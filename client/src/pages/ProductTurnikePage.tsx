  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Helmet>
        ...
        <meta property="og:image" content="https://mikateknoloji.com/mt-bel-tipi-turnike.png" />
        ...
        <meta property="twitter:image" content="https://mikateknoloji.com/mt-bel-tipi-turnike.png" />
