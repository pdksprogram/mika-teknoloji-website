...
const qrPdksDevice1 = "/rfid-turnstile-system.png";
const qrPdksDevice2 = "/qr-hand-mockup.png";
                ...
                <div className={`${index % 2 === 1 ? 'lg:order-2' : ''}`}>
                  <div className="relative group">
                    ...
                    <div className="relative bg-white p-8 rounded-2xl shadow-lg group-hover:shadow-xl transition-all duration-300">
                      <div className={`${system.id === 'qr' ? 'aspect-[4/3] max-w-lg' : system.id === 'rfid' ? 'aspect-[3/4] max-w-xs' : 'aspect-square max-w-md'} mx-auto overflow-hidden rounded-lg`}>
                        <img 
                          src={system.image} 
