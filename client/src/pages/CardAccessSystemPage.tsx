      ...
      <section className="py-20 bg-gradient-to-r from-slate-50 to-blue-50">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg text-slate-600 max-w-2xl mx-auto">
              Profesyonel access control sistemimizin ana bileşenleri
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 gap-12 max-w-5xl mx-auto">
            ...
            >
              <Card className="p-8 h-full shadow-lg hover:shadow-xl transition-shadow duration-300" data-testid="card-system-panel">
                <div className="mb-6">
                  <SmartImg 
                    src="/access-control-panel.png"
                    alt="Access Control Panel - Merkezi kontrol ünitesi, TCP/IP iletişim desteği"
                    width={300}
                    height={300}
                    className="w-full max-w-sm mx-auto h-auto rounded-lg shadow-md"
                    data-testid="img-access-control-panel"
                  />
                </div>
                <CardHeader>
                  <CardTitle className="text-xl text-slate-800 mb-3" data-testid="text-component-title">
                ...
                <CardContent>
                  <ul className="text-slate-600 space-y-2 text-left">
                    ...
                    <li className="flex items-center">
                      <CheckCircle className="h-4 w-4 text-blue-500 mr-2 flex-shrink-0" />
                      <span>Güvenli metal kasa</span>
                    </li>
                    <li className="flex items-center">
                      <CheckCircle className="h-4 w-4 text-blue-500 mr-2 flex-shrink-0" />
                      <span>Acil durum anahtarı</span>
                    </li>
                  </ul>
                </CardContent>
              </Card>
            ...
            <motion.div
              ...
              className="text-center"
            >
              <Card className="p-8 h-full shadow-lg hover:shadow-xl transition-shadow duration-300" data-testid="card-system-board">
                <div className="mb-6">
                  <SmartImg 
                    src="/access-control-professional.png"
                    alt="Access 16'lı Panel Kartı - 16 kapı kontrol kapasitesi, RS-485 iletişim protokolü"
                    width={300}
                    height={300}
                    className="w-full max-w-sm mx-auto h-auto rounded-lg shadow-md"
                    data-testid="img-access-control-board"
                  />
                </div>
                <CardHeader>
                  <CardTitle className="text-xl text-slate-800 mb-3" data-testid="text-component-title-2">
