...
export default function MTT300SlimKisaDetailPage() {
  const urunDetay = {
    model: "MT T300 HG SLIM",
    title: "Kısa SLIM Hızlı Geçiş",
    image: HIZLI_GECIS_TURNIKE_IMAGES.hg8,
    price: "Fiyat İçin Ara",
    description: "Kompakt SLIM tasarımlı hızlı geçiş turnike sistemi. Dar alanlara özel tasarım ile küçük ofis binaları ve mağaza girişleri için ideal çözüm.",
    
    teknikOzellikler: {
      "Geçiş Kapasitesi": "15 Kişi/Dakika",
      "Motor Tipi": "Kompakt Servo Motor",
      "Açılma Süresi": "0.6 Saniye",
      "Kasa Tipi": "Kısa SLIM Tasarım",
      "Kasa Malzemesi": "304 Paslanmaz Çelik",
      "Boyutlar": "900 x 200 x 850 mm",
      "Ağırlık": "45 kg",
      "Çalışma Voltajı": "220V / 50Hz",
      "Güç Tüketimi": "80W",
      "Çalışma Sıcaklığı": "-10°C ~ +55°C",
      "IP Koruma": "IP54",
      "Kart Okuyucu": "RFID, NFC",
      "İletişim": "TCP/IP, RS485",
      "Gürültü Seviyesi": "< 40dB",
      "Montaj": "Hızlı Montaj"
    },

    ozellikler: [
      "Kompakt SLIM tasarım",
      "Dar alanlarda kullanıma uygun",
  ...
  return (
    <>
      <Helmet>
        <title>MT T300 HG SLIM Kısa Turnike - Kompakt Tasarım | Mika Teknoloji</title>
        <meta name="description" content="MT T300 HG SLIM kısa turnike sistemi. Kompakt tasarım, dar alanlar için ideal, küçük işletmeler için ekonomik çözüm." />
        <meta name="keywords" content="slim turnike, kısa turnike, kompakt turnike, küçük işletme, dar alan turnike, ekonomik turnike, mika teknoloji" />
      </Helmet>
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <div className="flex items-center gap-3 mb-4">
                  <Minimize className="h-10 w-10 text-white" />
                  <div>
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                  <div className="text-center bg-white/10 rounded-lg p-3">
                    <Minimize className="h-6 w-6 mx-auto mb-2" />
                    <div className="text-sm text-white/80">Tasarım</div>
                    <div className="font-bold">Kompakt SLIM</div>
                  </div>
                  <div className="text-center bg-white/10 rounded-lg p-3">
                    <Clock className="h-6 w-6 mx-auto mb-2" />
                    <div className="text-sm text-white/80">Kapasite</div>
                    <div className="font-bold">15 Kişi/Dk</div>
                  </div>
                </div>
      ...
      <div className="bg-gray-50 py-4">
        <div className="container mx-auto px-4">
          <div className="flex items-center text-sm text-gray-600">
            ...
            <span className="mx-2">/</span>
            <span className="text-primary font-medium">MT T300 HG SLIM</span>
          </div>
        </div>
      </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              MT T300 HG SLIM kısa turnike sistemi küçük işletmeler için idealdir
            </p>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto">
            <h2 className="text-3xl font-bold mb-6">
              MT T300 HG SLIM Kısa Turnikenizi Hemen Sipariş Edin
            </h2>
            <p className="text-xl mb-8 text-white/90">
              Kompakt tasarım, dar alanlar için ideal, ekonomik çözüm için hemen iletişime geçin.
            </p>
