...
const videos = [
  ...
  },
  {
    ...
    title: "PDKS Düzeltme Onay Rehberi",
    description: "PDKS sisteminde düzeltme taleplerinin onaylanma sürecini anlatan kapsamlı rehber. Yönetici onay adımları ve düzeltme akışı.",
    src: "/pdks-duzeltme-onay-rehberi.mp4",
    duration: "2:00",
    category: "Demo",
    keywords: "PDKS düzeltme onay, düzeltme talebi onaylama, vardiya düzeltme rehberi, PDKS onay süreci",
  },
  {
    id: "pdks-mesai-talebi-egitimi",
    title: "PDKS Mesai Talebi Eğitimi",
    description: "PDKS üzerinden mesai talebi oluşturma ve onaylama eğitimi. Fazla mesai, ek mesai talepleri ve yönetici onay süreci.",
    src: "/pdks-mesai-talebi-egitimi.mp4",
    duration: "2:00",
    category: "Demo",
    keywords: "mesai talebi, fazla mesai onay, PDKS mesai, ek mesai talebi, mesai onaylama süreci",
  },
  {
    id: "yonetici-paneli-egitimi",
    title: "Yönetici Paneli Eğitimi",
    description: "PDKS yönetici panelinin detaylı kullanım eğitimi. Dashboard, raporlama, personel yönetimi ve sistem ayarları.",
    src: "/yonetici-paneli-egitimi.mp4",
    duration: "2:00",
    category: "Demo",
    keywords: "yönetici paneli, PDKS dashboard, yönetici eğitimi, personel yönetim paneli, PDKS raporlama",
  },
  {
    id: "pdks-personel-karti-yonetici-hatasi",
    title: "PDKS Personel Kartı - Yöneticinizle Görüşün Hatası Çözümü",
    description: "PDKS sisteminde 'Lütfen Yöneticinizle Görüşün' hatasının nedenleri ve çözüm yolları. Personel kartı sorun giderme rehberi.",
    src: "/pdks-personel-karti-yonetici-hatasi.mp4",
    duration: "2:00",
    category: "Demo",
    keywords: "PDKS hata çözümü, personel kartı hatası, yönetici görüşün hatası, PDKS sorun giderme, kart okuma hatası",
  },
  {
    id: "pdks-personel-excel-yazdirma",
    title: "PDKS Personel Excel ve Yazdırma Eğitimi",
    description: "PDKS sisteminden personel verilerini Excel'e aktarma ve yazdırma işlemleri. Rapor oluşturma ve veri dışa aktarma rehberi.",
    src: "/pdks-personel-excel-yazdirma-egitimi.mp4",
    duration: "2:00",
    category: "Demo",
    keywords: "PDKS Excel aktarma, personel raporu yazdırma, PDKS veri dışa aktarma, Excel rapor, personel listesi yazdırma",
  },
  {
    id: "pdks-personel-isten-cikarma-2",
    title: "PDKS Personel İşten Çıkarma Eğitimi - Bölüm 2",
    description: "Personel işten çıkarma sürecinin ikinci bölümü. İleri seviye çıkış işlemleri, toplu çıkış ve raporlama.",
    src: "/pdks-personel-isten-cikarma-egitimi-2.mp4",
    duration: "2:00",
    category: "Demo",
    keywords: "personel işten çıkarma bölüm 2, toplu çıkış işlemi, PDKS çıkış raporu, ileri seviye çıkış",
  },
  {
    id: "pdks-aylik-puantaj-olusturma",
    title: "PDKS Aylık Puantaj Oluşturma",
    description: "PDKS sisteminde aylık puantaj oluşturma işlemi. Personel devam kayıtlarından otomatik puantaj raporu hazırlama rehberi.",
    src: "/pdks-aylik-puantaj-olusturma.mp4",
    duration: "2:00",
    category: "Demo",
    keywords: "aylık puantaj, puantaj oluşturma, PDKS puantaj raporu, devam puantajı, personel puantaj",
  },
  {
    id: "pdks-aylik-puantaj-raporlar",
    title: "PDKS Aylık Puantaj Raporları",
    description: "PDKS aylık puantaj raporlarının incelenmesi ve analizi. Detaylı raporlama, filtreleme ve dışa aktarma işlemleri.",
    src: "/pdks-aylik-puantaj-raporlar.mp4",
    duration: "2:00",
    category: "Demo",
    keywords: "puantaj raporları, aylık rapor, PDKS raporlama, puantaj analizi, devam raporu",
  },
  {
    id: "pdks-genel-anlatim",
    title: "PDKS Genel Anlatım",
    description: "PDKS sisteminin genel tanıtımı ve temel özelliklerinin anlatımı. Yeni kullanıcılar için kapsamlı başlangıç rehberi.",
    src: "/pdks-genel-anlatim.mp4",
    duration: "3:00",
    category: "Demo",
    keywords: "PDKS genel anlatım, PDKS tanıtım, personel devam sistemi, PDKS başlangıç rehberi, PDKS nedir",
  },
  {
    id: "pdks-personel-karti-ekleme",
    title: "PDKS Personel Kartı Ekleme",
    description: "PDKS sistemine yeni personel kartı ekleme işlemi. Adım adım kart tanımlama, personel bilgileri girişi ve kart aktivasyonu.",
    src: "/pdks-personel-karti-ekleme.mp4",
    duration: "2:00",
    category: "Demo",
    keywords: "personel kartı ekleme, PDKS kart tanımlama, yeni kart oluşturma, personel kayıt, kart aktivasyonu",
  },
  {
    id: "pdks-tanimlari",
    title: "PDKS Tanımları",
    description: "PDKS sistemindeki temel tanımlar ve ayarlar. Departman, şube, mesai tipi ve diğer sistem tanımlarının yapılandırılması.",
    src: "/pdks-tanimlari.mp4",
    duration: "2:00",
    category: "Demo",
    keywords: "PDKS tanımları, sistem ayarları, departman tanımlama, mesai tipi, PDKS yapılandırma",
  },
  {
    id: "pdks-giris-cikis-islemleri",
    title: "PDKS Giriş Çıkış İşlemleri",
    description: "PDKS sisteminde personel giriş-çıkış kayıtlarının takibi ve yönetimi. Geç gelme, erken çıkma ve eksik kayıt kontrolü.",
    src: "/pdks-giris-cikis-islemleri.mp4",
    duration: "2:00",
    category: "Demo",
    keywords: "giriş çıkış işlemleri, PDKS kayıt takibi, geç gelme kontrolü, personel devam, mesai takibi",
  },
  {
    id: "pdks-giris-islemleri-izin-duzenleme",
    title: "PDKS Giriş İşlemleri - İzin Düzenleme",
    description: "PDKS giriş işlemlerinde izin düzenleme rehberi. Yıllık izin, mazeret izni ve diğer izin türlerinin düzenlenmesi.",
    src: "/pdks-giris-islemleri-izin-duzenleme.mp4",
    duration: "2:00",
    category: "Demo",
    keywords: "PDKS izin düzenleme, giriş işlemleri izin, yıllık izin düzenleme, mazeret izni, izin yönetimi",
  },
  {
    id: "pdks-giris-islemleri-duzenleme-2",
    title: "PDKS Giriş İşlemleri Düzenleme - Bölüm 2",
    description: "PDKS giriş-çıkış kayıtlarının düzenlenmesi. Manuel kayıt ekleme, düzeltme ve onay süreçleri.",
    src: "/pdks-giris-islemleri-duzenleme-2.mp4",
    duration: "2:00",
    category: "Demo",
    keywords: "giriş işlemleri düzenleme, PDKS kayıt düzeltme, manuel kayıt ekleme, devam düzenleme",
  },
  {
    id: "pdks-giris-islemleri-duzenleme-7",
    title: "PDKS Giriş İşlemleri Düzenleme - Bölüm 7",
    description: "PDKS giriş işlemlerinde ileri seviye düzenleme teknikleri. Toplu düzenleme ve özel durumların yönetimi.",
    src: "/pdks-giris-islemleri-duzenleme-7.mp4",
    duration: "2:00",
    category: "Demo",
    keywords: "ileri seviye düzenleme, PDKS toplu düzenleme, özel durum yönetimi, giriş işlemleri",
  },
  {
    id: "pdks-giris-islemleri-toplu-ekleme",
    title: "PDKS Giriş İşlemleri - Toplu Ekleme",
    description: "PDKS sisteminde toplu giriş-çıkış kaydı ekleme işlemi. Birden fazla personel için aynı anda kayıt girişi.",
    src: "/pdks-giris-islemleri-toplu-ekleme.mp4",
    duration: "2:00",
    category: "Demo",
    keywords: "toplu ekleme, PDKS toplu kayıt, çoklu personel giriş, toplu veri girişi",
  },
  {
    id: "pdks-giris-islemleri-toplu-izin",
    title: "PDKS Giriş İşlemleri - Toplu İzin",
    description: "PDKS sisteminde toplu izin girişi yapma rehberi. Birden fazla personele aynı anda izin tanımlama.",
    src: "/pdks-giris-islemleri-toplu-izin.mp4",
    duration: "2:00",
    category: "Demo",
    keywords: "toplu izin, PDKS toplu izin girişi, çoklu personel izin, toplu izin tanımlama",
  },
  {
    id: "esoft-pdks-login-sayfasi",
    title: "Esoft PDKS Login Sayfası",
    description: "PDKS sistemine giriş yapma rehberi. Kullanıcı adı ve şifre ile sisteme güvenli giriş, şifre sıfırlama ve oturum yönetimi.",
    src: "/esoft-pdks-login-sayfasi.mp4",
    duration: "2:00",
    category: "Demo",
    keywords: "PDKS login, PDKS giriş, sistem girişi, Esoft PDKS, kullanıcı girişi, oturum açma",
  },
  {
    id: "pdks-aktarim-formu-egitimi",
    title: "PDKS Aktarım Formu Eğitimi",
    description: "PDKS sisteminde aktarım formu kullanımı. Veri aktarma, form doldurma ve aktarım süreçlerinin yönetimi.",
    src: "/pdks-aktarim-formu-egitimi.mp4",
    duration: "2:00",
    category: "Demo",
    keywords: "PDKS aktarım formu, veri aktarma, form eğitimi, aktarım işlemleri, veri transferi",
  },
  {
    id: "pdks-avans-kazanc-kesinti",
    title: "PDKS Avans Kazanç Kesinti",
    description: "PDKS sisteminde avans, kazanç ve kesinti yönetimi. Personel maaş hesaplamaları, avans tanımlama ve kesinti işlemleri.",
    src: "/pdks-avans-kazanc-kesinti.mp4",
    duration: "2:00",
    category: "Demo",
    keywords: "PDKS avans, kazanç yönetimi, kesinti işlemleri, maaş hesaplama, personel ödeme",
  },
  {
    id: "pdks-barkodlarim",
    title: "PDKS Barkodlarım",
    description: "PDKS sisteminde barkod yönetimi. Personel barkod oluşturma, barkod okutma ve barkod bazlı giriş-çıkış takibi.",
    src: "/pdks-barkodlarim.mp4",
    duration: "2:00",
    category: "Demo",
    keywords: "PDKS barkod, barkod yönetimi, barkod oluşturma, barkod okutma, barkod takibi",
  },
  {
    id: "pdks-avans-talebi-egitim",
    title: "PDKS Avans Talebi Eğitimi",
    description: "PDKS sisteminde avans talebi oluşturma ve yönetimi. Personel avans başvurusu, onay süreci ve takip işlemleri.",
    src: "/pdks-avans-talebi-egitim.mp4",
    duration: "2:00",
    category: "Demo",
    keywords: "PDKS avans talebi, avans başvurusu, avans onay, personel avans, avans takibi",
  },
  {
    id: "pdks-izin-talep-egitimi",
    title: "PDKS İzin Talep Eğitimi",
    description: "PDKS sisteminde izin talebi oluşturma rehberi. Yıllık izin, mazeret izni ve diğer izin türlerinde talep ve onay süreçleri.",
    src: "/pdks-izin-talep-egitimi.mp4",
    duration: "2:00",
    category: "Demo",
    keywords: "PDKS izin talebi, izin başvurusu, yıllık izin talebi, mazeret izni, izin onay süreci",
  },
  {
    id: "turnike-montaj",
